...
// bir sınıftaki metod ve özelliklere erişmek istiyorsak öncelikle o sınıftan nesne üretmeliyiz.
...
print("sonuc: \(c)")
m.carp(sayi1: 30, sayi2: 45, isim: "ahmet") // bunu direkt print içine de yazdırabilirdik.
print(m)
